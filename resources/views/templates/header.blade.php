			...
			<div class="row">
				...
				<div class="topbar-left col-sm-3 col-xs-4">
					<a href="index.html" class="logo"> <img
						src="assets/images/logo.png" alt="" class="img-responsive">
					</a>
				</div>
				<!-- End Logo container-->
					...
					<ul class="nav navbar-nav navbar-right pull-right">
						...
						<li class="dropdown hidden-xs"><a href="#" data-target="#"
							...
							<ul class="dropdown-menu dropdown-menu-lg">
								...
								</a> <!-- last list item --> <a href="javascript:void(0);"
									class="list-group-item"> <small>Print all coupons</small>
								</a>
								</li>
							</ul></li>
